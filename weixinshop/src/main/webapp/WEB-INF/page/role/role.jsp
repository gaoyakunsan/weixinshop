...
%>
<script src="<%=path%>/pagejs/role/role.js"></script>
...
<div class="page-content">
	    ...
	    <div class="panel-heading"> 
	      <div class="panel-title"  flag="show" id="searchTitle">
	        <a data-toggle="collapse" data-parent="#accordion" href="#searchDiv" onclick="change()">
	        	角色搜索<i class="fa fa-plus-square"></i></a>
	      </div>
	      <script>
	           function  change(){
	...
	<div id="actions-before" class="btn-group">	
        <button type="button" onclick="addRole()" class="btn-link"><i class="glyphicon glyphicon-plus"></i> &nbsp;添加</button>
        <button type="button" onclick="editRole()" class="btn-link"><i class="glyphicon glyphicon-edit"></i> &nbsp;修改</button>
        <button type="button" onclick="deleteRole()" class="btn-link"><i class="glyphicon glyphicon-remove"></i> &nbsp;删除角色</button>
    </div>
	<div class="row">
		<div class="col-xs-12">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-md" onclick="saveRole()" >
			    	保存
			    </button>
